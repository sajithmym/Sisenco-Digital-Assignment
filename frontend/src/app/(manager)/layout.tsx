    ...
    <div className="min-h-screen flex relative">
      ...
      <div className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between border-b bg-card px-4 py-3 md:hidden">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-sm font-bold">{APP_SETTINGS.managerPanelTitle}</h2>
        </div>
        {user && (
      ...
      >
        <div className="flex h-full flex-col">
          <div className="p-6 hidden md:block">
            <h2 className="text-lg font-bold">{APP_SETTINGS.managerPanelTitle}</h2>
            {user && (
      ...
      <ConfirmationDialog
        ...
        description="You will need to sign in again to access reports and manager tools."
